...
MIDDLEWARE = [
    "django.middleware.security.SecurityMiddleware", "config.middleware.RequestLogMiddleware", "corsheaders.middleware.CorsMiddleware",
...
LOGGING = {
    ...
    "loggers": {"estampaflow.requests": {"handlers": ["console"], "level": LOG_LEVEL, "propagate": False}},
}
REST_FRAMEWORK = {
